...
Applications microservice can be used in different deployment scenarios.
...
The Applications microservice can also be used as a Seneca plugin.
...
var plugin = new require('service-applications-node').ApplicationsSenecaPlugin;
...
or by using [ApplicationsSenecaClient](https://github.com/pip-services-content2/client-applications-node/doc/NodeClientApiV1.md/#client_seneca)